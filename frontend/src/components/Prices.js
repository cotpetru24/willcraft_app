...
const Prices = () => {
    return (
        ...
        //             <Col xs={12} md={5}>
        //                 <Card className='home-review-card m-2' bg="light" text="dark" style={{ width: '32rem' }}>
        ...
        <>
<Container>
    <Row className="pt-5 justify-content-center align-items-stretch">
        <Col xs={12} md={5}>
            <Card className='home-review-card p-2 d-flex flex-column shadow' bg="light" text="dark" style={{ width: '100%', height: '100%' }}>
...
<Container>
    <Row className="pt-5 pb-5 justify-content-center align-items-stretch">
        <Col xs={12} md={5}>
            <Card className='home-review-card p-2 d-flex flex-column shadow' bg="light" text="dark" style={{ width: '100%', height: '100%' }}>

...
//     //         case 'Bank Account':
//     //             return `Bank Name: ${asset.bankName}`;
//     //         case 'Property':
//     //             return `Property Address: ${asset.propertyAddress}`;
//     //         case 'Stocks and shares':
//     //             return `Company Name: ${asset.companyName}`;
//     //         case 'Pension':
//     //         case 'Life insurance':
//     //             return `Provider: ${asset.provider}`;
//     //         case 'Other':
//     //             return `Details: ${asset.otherAssetDetails}`;
//     //         default:
//     //             return '';
//     //     }
//     // };
...
//         `- To ${beneficiary.beneficiary.fullLegalName} of ${beneficiary.beneficiary.fullAddress}, I leave ${beneficiary.amount}% of ${beneficiary.assetDetails} ${beneficiary.assetType}.`
//     ).join('\n')}

...
// //     saveAs(new Blob([pdfBytes], { type: 'application/pdf' }), 'will.pdf');
// // };
...
//     const addTextToPage = (text, fontSize) => {
...
//     addTextToPage(instructions, fontSize);
//     yPosition -= 2 * lineHeight; // Adding some space between sections
//     addTextToPage(willContent, fontSize);
